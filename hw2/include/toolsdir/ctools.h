...
extern int rolo_menu_yes_no (char * prompt,
          int rtn_default, int help_allowed,char * helpfile, char * subject);
extern void any_char_to_continue ();
extern void user_eof ();
extern void save_and_exit (int rval);
extern void roloexit (int rval);
...
extern int rolo_menu_data_help_or_abort 
  (char *prompt, char *helpfile, char *subject, char **ptr_response);
extern void display_field_names ();
extern int rolo_menu_number_help_or_abort 
  (char *prompt,int low, int high, int *ptr_ival);
